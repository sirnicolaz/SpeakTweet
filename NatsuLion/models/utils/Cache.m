...
+ (void)removeAllCachedData {
	[[NSFileManager defaultManager] removeItemAtPath:[Cache createIconCacheDirectory] error:nil];
	[[NSFileManager defaultManager] removeItemAtPath:[Cache createArchiverCacheDirectory] error:nil];
	[[NSFileManager defaultManager] removeItemAtPath:[Cache createTextCacheDirectory] error:nil];
}
