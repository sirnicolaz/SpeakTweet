...
@interface TwitterAccountViewController(Private)
...
- (void)viewWillAppear:(BOOL)animated {
	usernameOriginal = [[[Account sharedInstance] screenName] retain];
