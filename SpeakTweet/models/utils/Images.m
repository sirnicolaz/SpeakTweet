...
+ (UIImage*)loadFromResource:(NSString*)name withColor:(UIColor*)color {
	...
	return [Images colorizeImage:img color:color];
}

- (void)loadImagesWithPreferences {
	UIColor *color = [UIColor colorWithWhite:1.f alpha:1.f];
	iconChat			= [[Images loadFromResource:@"icons_03.png" withColor:color] retain];
	iconConversation	= [[Images loadFromResource:@"icons_03.png" withColor:color] retain];
	iconURL				= [[Images loadFromResource:@"icons_02.png" withColor:color] retain];
	iconSafari			= [[Images loadFromResource:@"icons_02.png" withColor:color] retain];
}
